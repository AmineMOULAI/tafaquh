...
export const JALSA_PROJECTS: JalsaProject[] = [
  {
    ...
    title: {
      ...
      en: "Explanation of the 40 Nawawiyyah Hadiths",
      fr: "Explication des 40 Hadiths Nawawi",
    },
    subtitle: {
      ar: "تأصيل قواعد الدين ومقاصد الشريعة بناءً على شرح الشيخ ابن عثيمين رحمه الله",
      en: "Rooting the core principles of faith based on the commentary of Shaykh Ibn al-Uthaymeen",
      fr: "Ancrage des fondements de la foi basé sur le commentaire de Cheikh Ibn al-Outhaymine",
    },
    description: {
      ar: "مدارسة تفاعلية لأحاديث الأربعين النووية التي تدور عليها أصول الإسلام، مع بيان فقه الحديث ودقائق استنباطاته العقدية والعملية بالاعتماد على شرح الشيخ العلامة محمد بن صالح العثيمين، مدعومة بمجالس صوتية في مجموعة تفقه على تيليجرام.",
      en: "Interactive study circle exploring the forty foundational Hadiths upon which Islam revolves, detailing jurisprudential, theological, and practical insights based on the commentary of Shaykh Muhammad ibn Salih al-Uthaymeen, accompanied by voice recordings from the Tafaqquh Telegram group.",
      fr: "Cercle d'étude interactif explorant les quarante Hadiths fondamentaux de l'Islam, détaillant la jurisprudence et les enseignements spirituels selon l'explication de Cheikh Muhammad ibn Salih al-Outhaymine, accompagné des enregistrements vocaux du groupe Telegram Tafaqquh.",
    },
    scholarlySource: {
    ...
    majalis: [
      {
        ...
        subtitle: {
          ...
          en: "Significance of intention, distinguishing the intent of action vs. intent for Allah, and the reality of Hijrah",
          fr: "Le statut de l'intention, distinction entre intention de l'acte et pour Qui on agit, et la réalité de la Hijrah",
        },
        date: "2026",
        duration: "42 دقيقة",
        durationSeconds: 2520,
        audioUrl: "/audio/majlis-40-nawawiya-1.mp3",
        telegramPostUrl: "https://t.me/center_tafaquh",
        telegramVoiceNoteInfo: {
          ar: "تسجيل صوتي رسمي للمجلس متوفر في مجموعة تفقه على تيليجرام",
          en: "Official voice recording of the session available in Tafaqquh Telegram group",
          fr: "Enregistrement vocal officiel de la session disponible dans le groupe Telegram Tafaqquh",
        },
        theme: {
          ar: "الإخلاص، النية، الهجرة، ميزان الباطن",
          en: "Sincerity (Ikhlas), Intention, Hijrah, Inward Scale of Deeds",
          fr: "Sincérité (Ikhlas), Intention, Hijrah, Balance intérieure des actes",
        },
        matn: {
  ...
  },
  {
    ...
    scholarlySource: {
      ar: "المفردات للراغب الأصفهاني، وتفاسير الطبري وابن كثير والقرطبي والزمخشري",
    ...
    majalis: [
      {
        ...
        sessionNumber: 1,
        title: {
          ar: "المجلس الأول: مدارسة لفظ «الْحَمْدُ» ودلالاته في القرآن",
        ...
        audioUrl: "/audio/majlis-gharib-quran-hamd.mp3",
        telegramPostUrl: "https://t.me/center_tafaquh",
        telegramVoiceNoteInfo: {
          ar: "تسجيل صوتي رسمي للمجلس متوفر في مجموعة تفقه على تيليجرام",
          en: "Official voice recording of the session available in Tafaqquh Telegram group",
        ...
        theme: {
          ...
          en: "Quranic Eloquence, Significance of Hamd, Linguistic Nuances, Quranic Openings",
          fr: "Éloquence coranique, Sémantique de Hamd, Nuances linguistiques, Ouvertures coraniques",
        },
        matn: {
