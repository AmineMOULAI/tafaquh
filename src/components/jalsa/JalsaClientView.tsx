        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 my-8 p-4 rounded-3xl bg-black/40 border border-gold/30 backdrop-blur-xl">
          ...
          <div className="w-full md:w-64 relative">
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 rounded-2xl bg-white/5 border border-gold/30 text-white placeholder-white/40 text-xs font-amiri focus:outline-none focus:border-gold transition-colors"
            />
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gold/50 pointer-events-none">
