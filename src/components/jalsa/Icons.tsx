...
export const StarGeometricIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2l2.4 2.4H17.8v3.4L20.2 10.2v3.6l-2.4 2.4v3.4h-3.4L12 22l-2.4-2.4H6.2v-3.4L3.8 13.8v-3.6l2.4-2.4V4.4h3.4z" />
  </svg>
);
